<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1AfterSign.Master" AutoEventWireup="true" CodeBehind="ProductsCaseFans.aspx.cs" Inherits="MyFirstWeb.pages.ProductsCaseFans" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="headline">
        <div class="page-content-inner">
            <img src="https://promotions.newegg.ca/nepro/24-0527/1920x120v2@2x.jpg" class="banner-flexible-img" alt="Video Cards" title="" style="">
        </div>
    </section>
    ...
    <section id="test" class="features products-page" style="">
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/DB.accdb" SelectCommand="SELECT * FROM [CaseFans]"></asp:AccessDataSource>
