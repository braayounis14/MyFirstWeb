<%@ Page Title="" Language="C#" MasterPageFile="~/pages/Site1AfterSign.Master" AutoEventWireup="true" CodeBehind="ProductsOperatingSystem.aspx.cs" Inherits="MyFirstWeb.pages.ProductsOperatingSystem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="headline">
        <div class="page-content-inner">
          <img src="../Images/OperatingSystemPic.jpg" class="banner-flexible-img" alt="Video Cards" title="" style="">
        </div>
    </section>
    ...
    <section id="test" class="features products-page" style="">
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/DB.accdb" SelectCommand="SELECT * FROM [OperatingSystem]"></asp:AccessDataSource>
